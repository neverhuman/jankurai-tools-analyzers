# jankurai-tools-analyzers Agent Instructions

Read `SPLIT.md` first. This repository is one member of the Jankurai split family.

- Canonical local Jeryu repo: `root/jankurai-tools-analyzers`.
- Public mirror target: `github.com/neverhuman/jankurai-tools-analyzers`.
