...
pub fn analyze(ctx: &AuditContext) -> DimensionResult {
    ...
    for (label, hard, advisory) in [
        ...
        (
            "comments",
            jankurai_audit_kernel::audit::language_rules::comments::summary(ctx).hard_findings,
            jankurai_audit_kernel::audit::language_rules::comments::summary(ctx).advisory_signals,
        ),
    ] {
