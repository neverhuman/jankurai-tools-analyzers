...
Applies to: jankurai-tools-analyzers

## Role

Language, web-security, repo-rot, coverage, migration, and repair detector source snapshots.

## Repositories

- Historical Jeryu repo: `root/jankurai-tools-analyzers`
- Primary GitHub repository: `neverhuman/jankurai-tools-analyzers`
- Release tag pattern: `jankurai-tools-analyzers-v1.7.0-split.0`
